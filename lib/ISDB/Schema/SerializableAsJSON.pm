...
package ISDB::Schema::SerializableAsJSON;
use base 'DBIx::Class';
use namespace::clean;

=head1 NAME

ISDB::Schema::SerializableAsJSON - Provides a TO_JSON method which dispatches to
as_hash

=head1 SYNOPSIS

    __PACKAGE__->load_components("+ISDB::Schema::SerializableAsJSON");
